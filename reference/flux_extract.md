...
flux_extract(
  ...
  site_ids = "all",
  network = c("AMF", "CNF", "EUF", "FLX", "ICOS", "JPF", "KOF", "SAEON", "TERN"),
...
Invisbly returns a dataframe of file paths and error messages if there
are any errors generated by unzipping.
